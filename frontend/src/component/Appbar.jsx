    ...
    return <div className="shadow h-14 flex justify-between">
        <div className="flex flex-col justify-center h-full ml-4 text-2xl font-bold">
            <div className="flex justify-center gap-2">
                EasyPay App
                <svg className="mt-1" fill="#000000" height="30px" width="30px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
        ...
        <div className="flex">
            ...
            <div className="flex flex-col justify-center h-full mr-4 cursor-pointer text-red-700 underline" onClick={()=>{navigate("/signin")}}>
                Sign Out
            </div>
